...
# ---------------------------------------------------------------------------
# llm-guard integration — KoreanPII should drop into scan_prompt().
# ---------------------------------------------------------------------------

def test_integrates_with_llm_guard_scan_prompt():
    """KoreanPII is usable inside upstream llm_guard.scan_prompt()."""
    from llm_guard import scan_prompt

    scanner = KoreanPII()
    sanitized, valid, risk = scan_prompt(
        [scanner], "내 주민번호는 901010-1234567"
    )
