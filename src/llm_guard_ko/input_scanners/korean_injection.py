...
from llm_guard_ko.patterns.korean import KOREAN_INJECTION_PATTERNS


class KoreanInjection:
    """Scan Korean text for prompt-injection phrases.

    Does not redact by default — for injection attempts, the caller
    almost always wants to reject the whole prompt rather than patch
    it up.
    """
